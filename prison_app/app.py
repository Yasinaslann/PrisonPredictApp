...
def load_data():
    ...
    try:
        ...
        st.error("Prisongüncelveriseti.csv dosyası bulunamadı. Lütfen dosyanın uygulamanızla aynı dizinde olduğundan emin olun.")
        return None
...
def load_model_and_preprocessors():
    ...
    try:
        ...
        st.error(f"Gerekli model veya ön işleme dosyası bulunamadı: {e}. Lütfen tüm dosyaların uygulamanızla aynı dizinde olduğundan emin olun.")
