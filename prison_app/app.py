...
DATA_FILE = BASE_DIR / "Prisongüncelveriseti.csv"  # Dataset dosyan

# Özellik açıklamaları (örnek, ihtiyaca göre genişlet)
FEATURE_DESCRIPTIONS = {
    "Gender": "Mahkumun cinsiyeti",
    "Race": "Mahkumun ırkı",
    "Age_at_Release": "Tahliye yaşı",
    "Gang_Affiliated": "Çete bağlantısı (True/False)",
    # diğer önemli özelliklere açıklamalar ekle
}

@st.cache_resource
def load_model_and_data():
    # Model ve ön işleme bilgilerini yükle
...
def analysis_page():
    ...
    # Kolon isimleri datasetine göre
    ...
    # Kullanıcının seçtiği bir özellik için grafik
    ...
    if selected_feature in cat_features or selected_feature in bool_cols:
        fig2 = px.histogram(filtered_df, x=selected_feature, color="Recidivism_Within_3years",
                            category_orders={selected_feature: filtered_df[selected_feature].unique().tolist()},
